...
def play_game(Method1,Difficulty1,Method2,Difficulty2):
    ...
    purple_bot = Bot(game, PURPLE, method=Method1, depth=Difficulty1)

    grey_bot = Bot(game, GREY, method=Method2,depth=Difficulty2)
...
class CheckersWindow(QWidget):
    def __init__(self):
        ...
        self.algorithm_combo.addItems(['random', 'minmax', 'alpha_beta'])
        ...
        self.algorithm_combo1.addItems(['random', 'minmax', 'alpha_beta'])
    ...
    def submit_clicked(self):
        ...
        difficulty1 = int(self.difficulty_combo.currentText())
        method2 = self.algorithm_combo1.currentText()
        difficulty2 = int(self.difficulty_combo1.currentText())
        self.close()
        play_game(method1, difficulty1, method2, difficulty2)
